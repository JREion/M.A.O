...
import trainers.mao_promptsrc_base
import trainers.mao_promptsrc_new
...
def extend_cfg(cfg):
    ...
    # [DPC] Configs of DPC: Dual-Prompt Collaboration for Tuning Vision-Language Models
    # Link of paper: https://arxiv.org/abs/2503.13443
    cfg.SPLE = CN()

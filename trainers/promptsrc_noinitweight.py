...
class PromptSRC_NOINIT(TrainerX):
    """
    [MAO_NEW] SKIP MODEL.INIT_WEIGHTS AS INFERENCE HEAD FOR MAO
    """
    ...
    def build_model(self):
        ...
        if cfg.MODEL.INIT_WEIGHTS:
            print("[MAO] ========= SKIP MODEL.INIT_WEIGHTS AS INFERENCE HEAD =========")
    ...
    def load_model(self, directory, epoch=None):
        ...
        for name in names:
            ...
            # [SPLE] 删除权重文件中，所有不进行梯度传播 (param.requires_grad = False)
